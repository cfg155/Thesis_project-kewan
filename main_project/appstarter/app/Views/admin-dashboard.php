...
<script>
    function generateChart(cLabels, cData, cTitle) {
        // initial chart
        const data = {
            labels: cLabels || null,
            datasets: [{
                ...
                $.ajax({
                    ...
                    success: function(result, status) {
                        ...
                        for (let i = 0; i < charts.length; i++) {
                            ...
                            new Chart(document.querySelectorAll('.chart')[i], generateChart(scoringData[i][0].labels, scoringData[i][0].dataValue, scoringData[i][0].title))
                        }
